/*
 * Reference-counted "the game is covered / paused" holds. The phone-landscape
 * rotate card and the pause menu each stop the WebGL frame: while any of them
 * holds, the engine skips rendering (engine.paused), so the last frame stays
 * on the glass, frozen, exactly like a paused console, and an unseen scene
 * never burns battery.
 *
