...
export interface ChapterContext {
  ...
  /**
   * Shared cabinet: backdrop gradient + pixel stars and game lighting. Set
   * world.params each frame (top, bottom, stars, keyDir, key, fill).
   */
  world: World
  post: Post
  assets: Assets
 ...
 * iris wipe in post (a circle closes to black and opens on the next level). Keep the first and last ~4% of local
