...
export default function create(): Chapter {
  ...
  return {
    ...
    group,
    init(ctx) {
      el('p', 'hud-eyebrow', 'World Map', ctx.stage).style.cssText = 'position:absolute;left:var(--gutter);top:var(--safe-top)'
    ...
    update(local, frame, ctx) {
      ctx.world.params.top = '#2fd4e0'
      ctx.world.params.bottom = '#00b862'
