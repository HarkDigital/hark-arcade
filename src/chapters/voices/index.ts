...
export default function create(): Chapter {
  ...
  return {
    ...
    group,
    init(ctx) {
      el('p', 'hud-eyebrow', 'Town Chatter', ctx.stage).style.cssText = 'position:absolute;left:var(--gutter);top:var(--safe-top)'
    ...
    update(local, frame, ctx) {
      ctx.world.params.top = '#3a7bff'
      ctx.world.params.bottom = '#2fd4e0'
