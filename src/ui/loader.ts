...
export function createLoader(root: HTMLElement, { skip = false } = {}) {
  root.innerHTML = `<div style="position:absolute;inset:0;display:grid;place-items:center;background:#0b0d14;font:12px var(--font-mono);color:#00ff85;transition:opacity .4s steps(3)">LOADING <span data-pct>000</span>%</div>`
