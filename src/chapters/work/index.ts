...
export default function create(): Chapter {
  ...
  return {
    ...
    group,
    init(ctx) {
      el('p', 'hud-eyebrow', 'Arcade Hall', ctx.stage).style.cssText = 'position:absolute;left:var(--gutter);top:var(--safe-top)'
    ...
    update(local, frame, ctx) {
      ctx.world.params.top = '#0b0d14'
      ctx.world.params.bottom = '#2c2f6b'
